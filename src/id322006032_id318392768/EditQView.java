...
public class EditQView extends ViewPatterns implements ViewClass {
	...
	public EditQView(ArrayList<String> questions) {
		this.borderPane = borderPaneCreation();
		this.borderPane.setTop(
				stackPaneTextCreation("Edit questions' Context. Choose the question you want to change context"));
		...
		this.comboBox = new ComboBox(FXCollections.observableArrayList(questions));
