...
public class AddClosedViewMoreAns extends ViewPatterns implements ViewClass {
	private BorderPane borderPane;
	private HBox hBoxAns, hBoxDown, hBoxChoice;
	...
	public AddClosedViewMoreAns(String question) {
		this.borderPane = borderPaneCreation();
		this.borderPane.setTop(stackPaneTextCreation("Adding Answers for: " + question));
		...
		this.vBox.getChildren().addAll(this.hBoxAns, this.hBoxChoice);
